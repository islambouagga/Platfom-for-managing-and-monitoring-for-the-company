<template>
    <div class="container mt-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title text-uppercase"
                        style="margin-bottom: 30px; font-weight: 800; font-size: 20px; color: #DE6262;">Projets et
                        fiches de suivi archive </h2>

                </div>
                <!-- /.table____________________________________________________- -->
                <div class="card-body">
                    <div class="container">
                        <p> Chercher dan la liste des projet archive :</p>
        ...
        <!-- Modal Fiche Table -->
        <div class="modal fade" id="ConsulterFiche" tabindex="-1" aria-labelledby="ConsulterFicheLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg form-dark" role="document">
                <div class="modal-content card card-image"
                     style="background: url('img/imgAcceuil/1.svg'); background-color: #ffffff">
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="modal fade" id="infoFiche" tabindex="-1" aria-labelledby="infoFichelLabel"
                             aria-hidden="true">
                            <div class="modal-dialog modal-lg form-dark" role="document">
                                <div class="modal-content card card-image"
                                     style="background: url('img/imgAcceuil/1.svg'); background-color: #ffffff">
                                    <div id="printMe" class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
                                        <div class="modal-header text-center pb-4">
                                            <h3 class="modal-title w-100 text-blue  font-weight-bold"
                                                id="infoFicheLabel"><strong>Detail de</strong>
                                                <a class="text-test font-weight-bold"> <strong>La fiche</strong></a>
                                            </h3>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col ">
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">ID : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            Fiche.id
                                                        }}</label>
                                                    <br>
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">Type : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            Fiche.type
                                                        }}</label>
                                                    <br>
                                            ...
                                            <div class="row">
                                                <div class="col ">
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">Date : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            Fiche.created_at | myDate
                                                        }} </label>
                                                    <br>
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">Date d'essai : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            Fiche.dateEssai
                                                        }}</label>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase"> Provenance : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            Fiche.provenance |upText
                                                        }}</label>
                                                    <br>
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">Destination : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            Fiche.destination |upText
                                                        }}</label>
                                                </div>
                                            </div>
                                            <hr style="height:6px; color:black; width:40%">
                                            <div class="row">
                                                <div class="col">
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">Nombre d'element Controle : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            Fiche.nbrElemCntrl
                                                        }}</label>
                                                    <br>
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">Type Materiaux : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            Fiche.typeMateriaux |upText
                                                        }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">Intervenant : </label>
                                                    <label data-error="wrong" data-success="right" class="text-green ">{{
                                                            user.nomUtilis |upText
                                                        }}
                                                        {{ user.prenomUtilis |upText }}</label>
                                                    <br>
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-uppercase">Projet : </label>
                                                    <label data-error="wrong" data-success="right"
                                                           class="text-green text-uppercase">{{ projet.nomPrj }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger " @click="closeModel3()">Fermer
                                        </button>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        showModal2(projet) {
            ...
            this.projet.fill(projet);
            this.fiches = projet.fiches_archives
            axios.get("api/wilayas/" + projet.wilayas).then(({data}) => (this.wilayatest = data));
        ...
        loadProjet() {
            ...
            axios.get("api/projetarchive").then(({data}) => (this.projets = data, console.log(data)));
